...
function resolveSmeScripts() {
  if (
    pkg.name === 'sme-scripts' ||
    // this happens on install of husky within sme-scripts locally
    appDirectory.includes(path.join(__dirname, '..'))
  ) {
    return require.resolve('./').replace(process.cwd(), '.');
  }
  return resolveBin('sme-scripts');
}
...
module.exports = {
  ...
  pkg,
  resolveBin,
  resolveSmeScripts: resolveSmeScripts,
  uniq,
  writeExtraEntry,
  here, hereRelative,
};
